...
public class NACheckBoxCreator extends LinearLayout{
    ...
    public NACheckBoxCreator(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public NACheckBoxCreator(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        LinearLayout.LayoutParams maxParams = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LinearLayout.LayoutParams minParams = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT);
        ...
        LinearLayout.LayoutParams hodlerParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
